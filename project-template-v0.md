...
> **v0.2 決策**：本提案以 `vibe-cloud-ready-spec-0913.md` 為最高指導原則。任何 repo template、workflow contract、SDK shim、排程、DB、檔案儲存、log 或部署流程，若與 DevOps spec 衝突，一律以 DevOps spec 為準。
>
