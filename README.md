...
本 repo 的最高指導原則是 [vibe-cloud-ready-spec-0913.md](vibe-cloud-ready-spec-0913.md)：目標環境是公司內部 AWS EKS、RDS PostgreSQL、S3、Kubernetes CronJob、stdout/stderr logging，以及由平台 config-manager 注入的 runtime env/secrets。任何提案、template 或 SDK 行為若與這份 DevOps spec 衝突，以 DevOps spec 為準。
...
```text
.
├── vibe-cloud-ready-spec-0913.md       # DevOps 上雲硬約束，最高優先級
...
從 `vibe-project-template/` 開新專案時，請把 [vibe-cloud-ready-spec-0913.md](vibe-cloud-ready-spec-0913.md) 視為驗收清單，而不是建議：
...
1. [vibe-cloud-ready-spec-0913.md](vibe-cloud-ready-spec-0913.md)
