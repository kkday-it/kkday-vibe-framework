...
> 定位:本 spec **擴充**既有守門機制(`vibe-project-template/scripts/guard/validate_project.py`、`PROJECT.yaml`、workflow `manifest.yaml`、gitleaks),不取代。與 [vibe-cloud-ready-spec-0913.md](vibe-cloud-ready-spec-0913.md) 衝突時以 cloud-ready spec 為準;與 [project-template-v0.md](project-template-v0.md)「風險分級與 guard」節治理形狀對齊。
>
